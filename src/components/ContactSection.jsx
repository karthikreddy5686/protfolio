...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-14 md:py-20 px-4 sm:px-6 md:px-12 bg-neutral-50/70 text-neutral-950 relative border-b border-neutral-200/80">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* Left Column: Compact Client Intake Form (lg:col-span-7) */}
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-7 rounded-2xl bg-white border border-neutral-200 shadow-md text-left">
              ...
              {submitted ? (
                <div className="py-8 text-center flex flex-col items-center animate-fade-in">
                  <div className="w-12 h-12 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-200 flex items-center justify-center mb-4 shadow-xs">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-neutral-950 text-white font-bold text-[11px] uppercase tracking-wider hover:bg-[#ea580c] transition-colors shadow-sm"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full pl-8 pr-3 py-2 rounded-lg bg-neutral-50/70 border border-neutral-300 text-neutral-950 placeholder:text-neutral-400 focus:bg-white focus:outline-none focus:border-neutral-950 transition-all text-xs font-medium shadow-2xs"
                        />
                      ...
                      {[
                        ...
                        return (
                          <button
                            ...
                            className={`p-2 rounded-lg border text-left text-[11px] font-bold transition-all flex items-center justify-between interactive ${
                              isSelected
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        {['Email', 'Phone Call'].map((method) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-2.5 py-1.5 rounded-lg border text-[10px] font-semibold flex items-center gap-1.5 transition-all interactive ${
                                isChecked
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2.5 py-1.5 rounded-lg bg-neutral-50/70 border border-neutral-300 text-neutral-950 focus:bg-white focus:outline-none focus:border-neutral-950 transition-all text-xs font-medium shadow-2xs cursor-pointer"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-neutral-50/70 border border-neutral-300 text-neutral-950 placeholder:text-neutral-400 focus:bg-white focus:outline-none focus:border-neutral-950 transition-all text-xs font-medium resize-none shadow-2xs"
                    />
                  </div>
                  ...
                  <div className="pt-1">
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-3 rounded-xl bg-neutral-950 hover:bg-[#ea580c] text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all interactive"
                    >
                      {loading ? (
