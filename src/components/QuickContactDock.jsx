  ...
  return (
    <aside aria-label="Quick contact and navigation" className="fixed bottom-6 right-6 z-40 flex flex-col items-center gap-3">
      ...
      <a
        ...
        className="w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white shadow-xl flex items-center justify-center transition-all duration-300 interactive hover:scale-110 group relative"
      ...
      >
        ...
        {/* Online Status Dot */}
        <span className="absolute top-0 right-0 w-3 h-3 rounded-full bg-emerald-300 border-2 border-white animate-pulse" />
      </a>
      ...
      {showScrollTop && (
        <button
          ...
          className="w-10 h-10 rounded-full bg-neutral-950 text-white shadow-lg hover:bg-[#ea580c] flex items-center justify-center transition-all interactive hover:scale-105 animate-fade-in"
