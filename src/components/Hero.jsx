...
export default function Hero() {
  return (
    <section id="home" className="relative w-full flex items-center justify-center pt-24 sm:pt-28 pb-3 px-4 sm:px-6 md:px-12 overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <h1 className="font-display font-medium text-lg sm:text-2xl md:text-3xl text-neutral-800 tracking-tight leading-snug mb-4 max-w-3xl">
